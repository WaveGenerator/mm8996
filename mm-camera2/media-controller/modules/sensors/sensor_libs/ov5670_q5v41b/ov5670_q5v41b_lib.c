...
static struct msm_camera_sensor_slave_info sensor_slave_info = {
  ...
  .power_setting_array = {
    .power_setting = ov5670_q5v41b_power_setting,
    .size = ARRAY_SIZE(ov5670_q5v41b_power_setting),
  },
};
...
static struct msm_camera_csid_vc_cfg ov5670_q5v41b_cid_cfg[] = {
  {0, CSI_RAW10, CSI_DECODE_10BIT},
  {1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params ov5670_q5v41b_csi_params = {
  .csid_params = {
    .lane_cnt = 2,
    .lut_params = {
      .num_cid = ARRAY_SIZE(ov5670_q5v41b_cid_cfg),
      .vc_cfg = {
         &ov5670_q5v41b_cid_cfg[0],
         &ov5670_q5v41b_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct sensor_pix_fmt_info_t ov5670_q5v41b_pix_fmt0_fourcc[] = {
  { V4L2_PIX_FMT_SBGGR10 },
};

static struct sensor_pix_fmt_info_t ov5670_q5v41b_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov5670_q5v41b_stream_info[] = {
  {1, &ov5670_q5v41b_cid_cfg[0], ov5670_q5v41b_pix_fmt0_fourcc},
  {1, &ov5670_q5v41b_cid_cfg[1], ov5670_q5v41b_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t ov5670_q5v41b_stream_info_array = {
  .sensor_stream_info = ov5670_q5v41b_stream_info,
  .size = ARRAY_SIZE(ov5670_q5v41b_stream_info),
};
...
//Video 1080p crop 30fps 24M MCLK 2lane 960Mbps/lane
  {0x3501, 0x45}, // exposure M
  {0x3623, 0x00}, // analog control
  {0x366e, 0x10}, // analog control
  {0x370b, 0x05}, // sensor control
  {0x3808, 0x07}, // x output size H
  {0x3809, 0x80}, // x output size L
  {0x380a, 0x04}, // y outout size H
  ...
  {0x382a, 0x01}, // y inc odd
  {0x4009, 0x0d}, // BLC, black line end line
  {0x400a, 0x01}, // BLC, offset trigger threshold H
  {0x400b, 0x62}, // BLC, offset trigger threshold L
  {0x4502, 0x40},
  {0x4508, 0xaa},
  {0x4509, 0xaa},
  {0x450a, 0x00},
...
//Video 640x480 90fps 24M MCLK 2lane 960Mbps/lane
  {0x3501, 0x1f}, //exposure M
  {0x3623, 0x04}, //analog control
  {0x366e, 0x08}, //analog control
  {0x370b, 0x1b}, //sensor control
  {0x3808, 0x02}, //x output size H
  {0x3809, 0x80}, //x output size L
  {0x380a, 0x01}, //y outout size H
  {0x380b, 0xe0}, //y output size L
  {0x380c, 0x06}, //HTS H
  {0x380d, 0x8c}, //HTS L
  {0x380e, 0x02}, //VTS H
  {0x380f, 0xa0}, //VTS L
  {0x3814, 0x07}, //x inc odd
  {0x3820, 0x90}, //vsyn48_blc on, vflip off
  {0x3821, 0xc6}, //dig_hbin4 on, hsync_en_o, mirror on, dig_bin off
  {0x382a, 0x07}, //y inc odd
  {0x4009, 0x05}, //BLC, black line end line
  {0x400a, 0x02}, //BLC, offset trigger threshold H
  {0x400b, 0x00}, //BLC, offset trigger threshold L
  {0x4502, 0x40},
...
//Video 640x480 120fps 24M MCLK 2lane 960Mbps/lane
  {0x3501, 0x1f}, //exposure M
  {0x3623, 0x04}, //analog control
  {0x366e, 0x08}, //analog control
  {0x370b, 0x1b}, //sensor control
...
static struct msm_camera_csi2_params *csi_params[] = {
  &ov5670_q5v41b_csi_params, /* RES 0*/
  &ov5670_q5v41b_csi_params, /* RES 1*/
  &ov5670_q5v41b_csi_params, /* RES 2*/
  &ov5670_q5v41b_csi_params, /* RES 3*/
  &ov5670_q5v41b_csi_params, /* RES 4*/
  &ov5670_q5v41b_csi_params, /* RES 5*/
};
...
static sensor_res_cfg_type_t ov5670_q5v41b_res_cfg[] = {
...
static struct sensor_res_cfg_table_t ov5670_q5v41b_res_table = {
  .res_cfg_type = ov5670_q5v41b_res_cfg,
  .size = ARRAY_SIZE(ov5670_q5v41b_res_cfg),
};

static struct sensor_lib_chromatix_t ov5670_q5v41b_chromatix[] = {
#if SNAPSHOT_PARAM
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(zsl), /* RES0 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(default_video), /* RES0 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES0 */
  },
#endif
#if PREVIEW_PARAM
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(preview), /* RES1 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(preview), /* RES1 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(default_video), /* RES1 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES1 */
  },
#endif
#if VIDEO_1080P_PARAM
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(video_hd), /* RES2 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(video_hd), /* RES2 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(video_hd), /* RES2 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES2 */
  },
#endif
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_60fps), /* RES3 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_60fps), /* RES3 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_60fps), /* RES3 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES3 */
  },
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_90fps), /* RES4 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_90fps), /* RES4 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_90fps), /* RES4 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES4 */
  },
  {
    .common_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_120fps), /* RES5 */
    .camera_snapshot_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_120fps), /* RES5 */
    .camcorder_chromatix = OV5670_Q5V41B_LOAD_CHROMATIX(hfr_120fps), /* RES5 */
    .liveshot_chromatix =  OV5670_Q5V41B_LOAD_CHROMATIX(liveshot), /* RES5 */
  },
};

static struct sensor_lib_chromatix_array ov5670_q5v41b_lib_chromatix_array = {
  .sensor_lib_chromatix = ov5670_q5v41b_chromatix,
  .size = ARRAY_SIZE(ov5670_q5v41b_chromatix),
};

/*===========================================================================
 * FUNCTION    - ov5670_q5v41b_real_to_register_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t ov5670_q5v41b_real_to_register_gain(float gain)
{
  uint16_t reg_gain;
...
/*===========================================================================
 * FUNCTION    - ov5670_q5v41b_register_to_real_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static float ov5670_q5v41b_register_to_real_gain(uint16_t reg_gain)
{
  float real_gain;
...
/*===========================================================================
 * FUNCTION    - ov5670_q5v41b_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5670_q5v41b_calculate_exposure(float real_gain,
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  if (!exp_info) {
    return -1;
  }
  exp_info->reg_gain = ov5670_q5v41b_real_to_register_gain(real_gain);
  exp_info->sensor_real_gain = ov5670_q5v41b_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - ov5670_q5v41b_fill_exposure_array -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5670_q5v41b_fill_exposure_array(uint16_t gain, uint32_t line,
...
static sensor_exposure_table_t ov5670_q5v41b_expsoure_tbl = {
  .sensor_calculate_exposure = ov5670_q5v41b_calculate_exposure,
  .sensor_fill_exposure_array = ov5670_q5v41b_fill_exposure_array,
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  /* csi cid params */
  .csi_cid_params = ov5670_q5v41b_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(ov5670_q5v41b_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &ov5670_q5v41b_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &ov5670_q5v41b_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &ov5670_q5v41b_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &ov5670_q5v41b_lib_chromatix_array,
...
/*===========================================================================
 * FUNCTION    - ov5670_q5v41b_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *ov5670_q5v41b_open_lib(void)
{
